"""
AI-powered GitHub PR review bot using Groq LLM.

This bot fetches PR diffs from GitHub, chunks them for processing,
and generates AI-powered reviews using Groq's LLM API.
"""
...
def fetch_diff():
    ...
    r2 = requests.get(diff_url, headers=headers, timeout=10)
    r2.raise_for_status()
    return r2.text
