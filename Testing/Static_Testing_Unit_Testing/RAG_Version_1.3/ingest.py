"""
Data ingestion script: loads documents, splits them, embeds them, and uploads them to Pinecone.
"""
...
if __name__ == "__main__":
    if not os.path.exists(KNOWLEDGE_BASE_DIR):
        print(
            f"Error: Knowledge base directory not found at '{KNOWLEDGE_BASE_DIR}'"
        )
        print(
            "Please create it and add your documents (e.g., .md, .txt files)."
        )
    else:
        ingest_data()
